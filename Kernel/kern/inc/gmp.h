...
#define __GMP_CC "arm-angstrom-linux-gnueabi-gcc  -march=armv7-a -marm -mthumb-interwork -mfloat-abi=hard -mfpu=neon --sysroot=/data/jdasilva/angstrom/setup-scripts/build/tmp-angstrom_v2014_12-glibc/sysroots/socfpga"
