	fpgame_soc u0 (
		...
		.dma_engine_src_addr         (<connected-to-dma_engine_src_addr>),         //     dma_engine.src_addr
		.dma_engine_start            (<connected-to-dma_engine_start>),            //               .start
		.dma_engine_finish           (<connected-to-dma_engine_finish>),           //               .finish
		...
		.vramsrcaddrpio_rddata       (<connected-to-vramsrcaddrpio_rddata>),       // vramsrcaddrpio.rddata
		.vramsrcaddrpio_update_avail (<connected-to-vramsrcaddrpio_update_avail>), //               .update_avail
		.vramsrcaddrpio_read_rst     (<connected-to-vramsrcaddrpio_read_rst>)      //               .read_rst
	);
